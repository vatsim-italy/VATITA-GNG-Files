...
· It'll open a new popup and then choose the Runway Condition Report - here you can choose between code 6 (dry) and code 5 (wet). For apts with LVPs the rwy CC **must not** be used since it is already included in
